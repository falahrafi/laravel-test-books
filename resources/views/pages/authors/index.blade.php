...
<div class="p-4 pt-4 sm:ml-64">
  ...
  <table id="selection-table">
      ...
      <tbody>
        ...
        <tr id="author-{{ $author->id }}" class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
            ...
            <td class="text-lg text-gray-800 dark:text-white font-bold">{{ $author->name }}</td>
            <td class="text-lg text-gray-800 dark:text-white">{{ $author->email }}</td>
            <td>
                <a href="{{ route('authors.edit', $author->id) }}" class="inline-flex items-center text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 shadow-lg shadow-teal-500/50 dark:shadow-lg dark:shadow-teal-800/80 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete this author and all of their related books?</h3>
...
<script>
    ...
    document.getElementById('confirmDelete').addEventListener('click', function () {
        if (authorIdToDelete) {
            ...
            .then(data => {
                if (data.success) {
                    document.getElementById(`author-${authorIdToDelete}`).remove();
                    alert(data.message);
                } else {
